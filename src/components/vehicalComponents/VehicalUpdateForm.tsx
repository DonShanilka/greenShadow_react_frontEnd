...
import { updateVehicle } from '../../reducer/VehicalSlice';
import { useDispatch } from 'react-redux';

function VehicalUpdateForm({ onClose, initialData }) {
  ...
  const handleUpdate = (e) => {
    ...
    if (
      ...
      dispatch(updateVehicle(formData)); // Dispatch the updated data
...
export default VehicalUpdateForm
